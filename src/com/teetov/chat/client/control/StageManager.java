...
/**
 *  ласс хранит основныме элементы GUI и обеспечивает между ними взаимодействие.
...
public class StageManager implements ConnectionController, ConnectionLifeCircle {
	...
	/**
	 * ¬озвращает основной {@code Stage} этого приложени€.
	 * @return
	 */
	...
	/**
	 * ¬озвращает контроллер, управл€ющий диалоговой панелью чата.  
	 * @return
	 */
	...
	/**
	 * »нициализирует и начинает отображать корневую {@code Scene} приложени€.
	 * ќсновным еЄ содержимым €вл€етс€ главне меню.
	 */
	...
	/**
	 * »нициализирует контроллер, управл€ющий диалоговой панелью чата.  
	 */
	...
	/**
	 * ѕроизводит попытку установить новое соединение.
	...
	/**
	 * ”станавливает новое соединение с сервером.
	 * Ќастройки соединеие берутс€ из property файлов.
	 * Ќовое соединение не будет установлено если в 
	...
	/**
	 * ќтобразить окно-предупреждение.
	 * @param title 
	 * @param header
	 * @param content
	 */
	...
	/**
	 * «апрашивает у пользовател€ ввод конкретной информации.
	 * 
	 * @param info по€снение дл€ пользовател€, что от него хот€т получить
	 * @return введЄнный пользователем текст. {@code null} в случае, если пользователь отказалс€ отвечать на запрос.
	 */
	...
	/**
	 * ќтдаЄт текущему соединению с сервером команду завершитьс€.
	 * ¬ случае, если соединение ещЄ не установлено или уже закрыто, ничего не происходит.
	 */
	...
	/**
	 * ¬озвращает текущее соединение.
	 * @return соединение или {@code null}, если оно ещЄ не было установлено
	 */
	...
	/**
	 * ѕровер€ет, находитс€ ли текущее соединение в активном состо€нии.
	 * @return {@code null}, если соединение ещЄ не установлено или уже закрыто
	 */
